...
if waves = 17
{
repeat 3 {script_execute(script0,0,0,0,0,0);  monster = instance_create(680+random_range(-32,32),y_line,obj_rex)}
...
repeat 4 {script_execute(script0,0,0,0,0,0);  monster = instance_create(680+random_range(-32,32),y_line,obj_hardcore)};
repeat 3 {script_execute(script0,0,0,0,0,0);  monster = instance_create(680+random_range(-32,32),y_line,obj_rex)}
repeat 5 {script_execute(script0,0,0,0,0,0); monster = instance_create(1000+random_range(-100,100),y_line,obj_sandstorm);
            monster.hp = random_range(120,180);monster.zoms = 7}
repeat 10 {script_execute(script0,0,0,0,0,0);  monster = instance_create(1000+random_range(-100,100),y_line,obj_sandstorm);
