...
action_font(font1, 1);
action_color(0);
action_draw_text("Desert - Day 3", 360, 465);
action_color(0);
...
action_color(65280);
action_font(font1, 0);
action_draw_text("In this type of level, with the given amount of sun#we'll plant our defense first. The team lineup shall withstand#all attack waves of monsters in order to win!", 32, 320);
}
}
}
