...
action_inherited();
var __b__;
__b__ = action_if(powering=1 or squashing = 1);
if __b__
{
pr.hp = hp_max;
}
...
__b__ = action_if((distance <75 and mons.line = line) and powering = 0 and mons.immue=0);
if __b__
{
{
...
__b__ = action_if_number(obj_enemies, 0, 2);
if __b__
{
{
x_0 = x;
