...
alarm[0] = 600}
if waves = 5
{script_execute(script0,0,0,0,0,0); monster = instance_create(680+random_range(-32,32),y_line,obj_slime); monster.size = 2
 alarm[0] = 600}
 if waves =6
...
script_execute(script0,0,0,0,0,0); monster = instance_create(680+random_range(-32,32),y_line,obj_slime); monster.size = 3
}
