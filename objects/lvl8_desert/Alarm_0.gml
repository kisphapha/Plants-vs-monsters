...
for (i=1; i<=5; i+=2) {script0(i); monster = instance_create(680+random_range(-32,32),script0(0),obj_sandstorm);
...
for (i=2; i<=5; i+=2) {script0(i); monster = instance_create(680+random_range(-32,32),script0(0),obj_sandstorm);
...
repeat 7 {  monster = instance_create(680+random_range(-32,32),script0(0),obj_driller)}
