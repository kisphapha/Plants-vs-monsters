...
{ monster = instance_create(680+random_range(-32,32),script0(0),obj_monster); alarm[0] = 800}
...
{repeat 2 {  monster = instance_create(680+random_range(-32,32),script0(0),obj_monster)};
 ...
 monster = instance_create(680+random_range(-32,32),script0(0),obj_krockodile)
...
alarm[0] = 800}
 ...
 if waves = 15 or waves = 16 or waves = 17
