...
{   
	...
	{
		draw_sprite_part_ext(sprite_index,image_index,0,0,sprite_width,sprite_height-20,x-40,y-48,image_xscale,image_yscale,image_blend,image_alpha)
	}
    else 
	{
...
if (!dead && is_buttered)
{
	draw_sprite_ext(spr_butter,1,x,y-24,1,1,45,image_blend,1)
}
