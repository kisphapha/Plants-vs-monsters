...
with game 
{
	...
	plants_library = [
		...
		},
		{
			...
			description : "Throw a heavy melon into the monsters which cause heavy damage and even spread to surrounding\n"+
			"They're often misunderstood throwing their child. Actually thier child are not born from their catapult. The reproduction of melon-pult is so complex that it should not be mentioned here!",
			quotation : "\"Go my child!! Hit them dummy monsters!\"",
			plant_food : "Become a melon mortar that shoot multiple charged melons into the sky which then cause a melon rain damages many monsters in a large area",
			picture : spr_melon,
