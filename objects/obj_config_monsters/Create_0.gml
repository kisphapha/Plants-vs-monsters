...
with game {
	...
	monsters_library = [
		...
		{
			mons_id : 30,
			picture : spr_fireghoul,
			picture_scale : 1,
			monster_name : "Firegoul",
			quotation : "\"Wooops, I accidentally made your plant burned!\"",
			behavior : "Floating and burning your plants immediately on touch, except for fire and armored plants",
			anecdote : "Firegouls appear everywhere throughout the Volcanic. They're the ghosts of this world. The ghosts should bring chill to your spine but Firegouls would melt it instead!",
			toughness : monster_hp_level[2],
			speed_lvl : monster_speed_level[3],
			dame_lvl : monster_damage_level[5],
			class : [0,3],
			...
			dame : 0,
			map : 6,
			obj_form : obj_fireghoul,
			weight : 2,
			floating : 0
		},
		{
			mons_id : 31,
			picture : spr_lavabull,
			picture_scale : 1,
			monster_name : "Lavabull",
			quotation : "\"Miss a moment, and now you're dead!\"",
			behavior : "Charging continuously into your plants, each hit deal a massive damage but with a small recharge",
			anecdote : "Lavabull love bathing in lava, they make them heal. Lava to them is like water to human. As a result of bathing lava 24/7, their skin are mostly stoned and very durable. Despite heavy bodyweight, they're one of the fastest monsters",
			toughness : monster_hp_level[3],
			speed_lvl : monster_speed_level[5],
			dame_lvl : monster_damage_level[4],
			class : [0,3],
			...
			dame : 0,
			map : 6,
			obj_form : obj_lavabull,
			weight : 4,
			floating : 0
		},
		{
			mons_id : 32,
			picture : spr_goluk_full,
			picture_scale : 1,
			monster_name : "Goluk",
			quotation : "\"I... am... Goluk\"",
			behavior : "A very strong rock golem entity. They move slowly but are capable of tossing nearby monsters into the front.",
			anecdote : "Goluk is so colossal that they would solo Gigantics. Though Immeror proudly consider them as unstoppable when created, they're pretty much have intellectual disability",
			toughness : monster_hp_level[4],
			speed_lvl : monster_speed_level[1],
			dame_lvl : monster_damage_level[5],
			class : [2,4],
		...
		},
		{
			...
			picture_scale : 1,
			monster_name : "Jigoku",
			quotation : "\"Hell... is my name!\"",
			behavior : "They flies menacingly and can reincarnate your plants from far away, ensure a proper protection when encounter them. They also refuse death so take them seriously",
			anecdote : "Jigoku are more loyal to Qwrath instead of Immeror. They're top tier monsters. Having them as enemies is nightmare. They're demonic, inhuman. Even Gigantics are afraid of them",
			toughness : monster_hp_level[4],
			speed_lvl : monster_speed_level[3],
			dame_lvl : monster_damage_level[5],
			class : [1],
		...
		},
		{
			...
			picture_scale : 1,
			monster_name : "Qwrath",
			quotation : "\"Why become small when you can do big?\"",
			behavior : "The headmaster of Volcanic. This red giant dragon will demolish your defense with the roar of anger, along with a storm of volcanic debris and dust. Their flame are hellish and even damage your soil. Last but not least, they're able to use 'Tekkai' to become completely invincible if needed!",
			anecdote : "Qwrath is Immeror's pet. He has been nourished since he was a baby. Immeror's death make Qwrath furious than ever. He is now going crazy destroying everything, heating the Volcanic to its prime. He will not stop until successfully unsealed Immeror fragment and bring him back!",
			toughness : monster_hp_level[7],
			speed_lvl : monster_speed_level[0],
			dame_lvl : monster_damage_level[6],
			class : [6],
		...
		{
			mons_id : 35,
			picture : spr_eggmystery,
			picture_scale : 1,
			monster_name : "Mysterious Egg Basic Pack",
			quotation : "\"W?\"",
			behavior : "!",
			anecdote : "!",
			toughness : monster_hp_level[1],
		...
		},
		{
			...
			picture : spr_eggmystery,
			picture_scale : 1,
			monster_name : "Mysterious Egg Standard Pack",
			quotation : "\"W?\"",
			behavior : "!",
			anecdote : "!",
			toughness : monster_hp_level[2],
			...
			dame : 0,
			map : 7,
			obj_form : obj_eggmonster_standard,
			weight : 6,
			floating : 1
		},
		{
			...
			picture : spr_eggmystery,
			picture_scale : 1,
			monster_name : "Mysterious Egg VIP Pack",
			quotation : "\"W?\"",
			behavior : "!",
			anecdote : "!",
			toughness : monster_hp_level[3],
